...
- Real D3 Generate lifecycle: PENDING one operator-authorized run.
...
- Provider observation: UI showed `Không tải được giọng. Vui lòng tải lại trang.` after voice-surface observation; this did not invalidate D2 semantic capture and is treated as baseline context for D3.
